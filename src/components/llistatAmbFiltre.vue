...
export default {
    ...
    components:{pokeCardComponent},
    props:{},
    data:function(){ return{
        // Valors generals al template
        arrayNoms:[],
        arrayPokes:[],
        arrayPokes1:[1,2,3,4,5],
        // Valors pel filtre
        filterEntrada:"",
        filterInput:"",
        filterOption:"",
...
<template>
    ...
    <div>
        ...
        <!--
        <ul>
            <li v-for="poke1 in arrayNoms">
                NOTA: Aixo NO funciona pq el v-for NO es reactiu 
                <pokeCardComponent /> 
                {{poke1}}
            </li>
        </ul>
        -->
        <div id="llistatPokes">LLISTA DINAMICA</div>
    </div>
</template>
